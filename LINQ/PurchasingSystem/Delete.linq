...
void Main()
{
	try
	{
		...
		// --- --- --- --- --- --- --- --- --- ---
		// START - GOOD DATA FOR DELETE PURCHASE ORDER
		// --- --- --- --- --- --- --- --- --- ---
		//purchaseOrderID = CreatePurchaseOrderForDelete(vendorIDWithActiveOrder);
		// --- --- --- --- --- --- --- --- --- ---
		// END - GOOD DATA FOR DELETE PURCHASE ORDER
		// --- --- --- --- --- --- --- --- --- ---

		// --- --- --- --- --- --- --- --- --- ---
		// START - BAD DATA FOR DELETE PURCHASE ORDER
		// PURCHASE ORDER ID = 0
		// --- --- --- --- --- --- --- --- --- ---
		//purchaseOrderID = 0;
		// --- --- --- --- --- --- --- --- --- ---
		// END - BAD DATA FOR DELETE PURCHASE ORDER
		// --- --- --- --- --- --- --- --- --- ---
		...
		// --- --- --- --- --- --- --- --- --- ---
		// START - BAD DATA FOR DELETE PURCHASE ORDER
		// PURCHASE ORDER ALREADY PLACED
		// --- --- --- --- --- --- --- --- --- ---
		//purchaseOrderID = CreatePlacedPurchaseOrderForDelete(vendorIDWithActiveOrder);
		// --- --- --- --- --- ---
		// END - BAD DATA FOR DELETE PURCHASE ORDER
		// --- --- --- --- --- --- --- --- --- ---
...
{	
	...
	{	
		List<PurchaseOrderDetails> purchaseOrderDetails = PurchaseOrderDetails
...
public int GetLastCreatedPurchaseOrder()
{
	return PurchaseOrders
			.OrderByDescending(po => po.PurchaseOrderID)
			.Take(1)
			.Select(po => po.PurchaseOrderID).FirstOrDefault();
}
#endregion
...
public int CreatePlacedPurchaseOrderForDelete(int vendorID)
{
	PurchaseOrderView purchaseOrder = CreateGoodPurchaseOrder(vendorID, false);
	purchaseOrder.OrderDate = DateTime.Now;
	SavePurchaseOrder(purchaseOrder);
	DisplayOrders();
	return GetLastCreatedPurchaseOrder();
}

public int CreatePurchaseOrderForDelete(int vendorID)
{
	PurchaseOrderView purchaseOrder = CreateGoodPurchaseOrder(vendorID, false);
	SavePurchaseOrder(purchaseOrder);
	DisplayOrders();
